;(function () {
	...
	var mobileMenuOutsideClick = function() {
	    ...
	    var container = $("#main-offcanvas, .js-main-nav-toggle");
	...
	var offcanvasMenu = function() {
		...
		$('#page').prepend('<div id="main-offcanvas" />');
		$('#page').prepend('<a href="#" class="js-main-nav-toggle main-nav-toggle main-nav-white"><i></i></a>');
		var clone1 = $('.menu-1 > ul').clone();
		$('#main-offcanvas').append(clone1);
		var clone2 = $('.menu-2 > ul').clone();
		$('#main-offcanvas').append(clone2);

		$('#main-offcanvas .has-dropdown').addClass('offcanvas-has-dropdown');
		$('#main-offcanvas')
			.find('li')
