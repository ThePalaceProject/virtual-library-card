...
try:
    from virtual_library_card._version import __version__
except (ModuleNotFoundError, ImportError):
    __version__ = None

try:
    from virtual_library_card._version import __commit__
except (ModuleNotFoundError, ImportError):
    __commit__ = None

try:
    from virtual_library_card._version import __branch__
except (ModuleNotFoundError, ImportError):
    __branch__ = None
